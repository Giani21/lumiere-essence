        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-12 mb-16">
          ...
          <div className="flex flex-col gap-6 sm:col-span-2 lg:col-span-1">
            <Link to="/" className="group w-fit">
              <img
                ...
                alt="Lumière Essence"
                className="h-14 sm:h-16 w-auto object-contain transition-all duration-500 group-hover:opacity-80"
              />
            </Link>
          ...
          <div className="flex flex-col gap-5 border-t-2 border-stone-300/50 pt-8 lg:border-none lg:pt-0">
            ...
            <div className="flex items-center gap-4 mt-2">
              <SocialIcon href="https://www.instagram.com/lumiereessence.ar/" icon={<Instagram size={14} strokeWidth={2.5} />} />
